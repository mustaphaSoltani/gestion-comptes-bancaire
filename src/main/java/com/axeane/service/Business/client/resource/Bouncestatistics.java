 ...
 */
public class Bouncestatistics {

    public static Resource resource = new Resource("bouncestatistics", "");

	public static String BOUNCEDAT = "BouncedAt";
	public static String CAMPAIGN = "Campaign";
	public static String CONTACT = "Contact";
	public static String ID = "ID";
	public static String ISBLOCKED = "IsBlocked";
	public static String ISSTATEPERMANENT = "IsStatePermanent";
