...
import com.axeane.web.util.client.easy.MJEasyClient;
...
import com.axeane.web.util.client.resource.Contact;
...
public class MJEasyEmail {
     ...
     */
    public MailjetResponse send() throws MailjetException, MailjetSocketTimeoutException, MailjetRateLimitException, MailjetServerException {
