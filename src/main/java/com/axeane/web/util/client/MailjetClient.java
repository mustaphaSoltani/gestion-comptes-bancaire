...
package com.axeane.web.util.client;

import com.axeane.web.util.client.Base64;
...
import static com.axeane.web.util.client.MailjetResponseUtil.validateMailjetResponse;
...
public class MailjetClient {
     ...
     */
     public MailjetResponse get(MailjetRequest request) throws MailjetException, MailjetSocketTimeoutException, MailjetRateLimitException, MailjetServerException {
        try {
     ...
     * @param request
     * @return
     * @throws com.axeane.web.util.client.errors.MailjetException
     */
    public MailjetResponse post(MailjetRequest request) throws MailjetException, MailjetSocketTimeoutException, MailjetRateLimitException, MailjetServerException {
        try {
            String url = createUrl() + request.buildUrl();
    ...
    public MailjetResponse put(MailjetRequest request) throws MailjetException, MailjetSocketTimeoutException, MailjetRateLimitException, MailjetServerException {
        try {
            String url = createUrl() + request.buildUrl();
            HttpResponse response;
    ...
    public MailjetResponse delete(MailjetRequest request) throws MailjetException, MailjetSocketTimeoutException, MailjetRateLimitException, MailjetServerException {
        try {
            String url = createUrl() + request.buildUrl();
            HttpResponse response;
            String json;
