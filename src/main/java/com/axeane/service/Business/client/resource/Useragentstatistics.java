...
public class Useragentstatistics {
    ...
    public static Resource resource = new Resource("useragentstatistics", "");

	public static String COUNT = "Count";
	public static String DISTINCTCOUNT = "DistinctCount";
	...
	public static String EXCLUDEPLATFORM = "ExcludePlatform";
